...
namespace Engine.Models
{
    public class Location
    {
        ...
        {/*
          * taking the paramaters of chance to encurnter some monster and 
          * Based on these numbers - calculates the chance (randomly according to the chance ratio) to meet a monster
          */
            if (!MonstersHere.Any())
            {
                return null;
